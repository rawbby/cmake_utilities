...
foreach (TARGET_DIR ${SHARED_DIRS})
    ...
    glob_module(TARGET_SRC_MODULES "${TARGET_DIR}/src")
    glob_module(TARGET_INCLUDE_MODULES "${TARGET_DIR}/include")
    ...
    target_sources(${TARGET_NAME} PRIVATE FILE_SET target_src_modules TYPE CXX_MODULES FILES ${TARGET_SRC_MODULES})
    target_sources(${TARGET_NAME} PUBLIC FILE_SET target_include TYPE HEADERS FILES ${TARGET_INCLUDE})
    target_sources(${TARGET_NAME} PUBLIC FILE_SET target_include_modules TYPE CXX_MODULES FILES ${TARGET_INCLUDE_MODULES})
    ...
    install(TARGETS ${TARGET_NAME}
            ...
            FILE_SET target_include_modules DESTINATION "${TARGET_INCLUDE_INSTALL_DIRECTORY}"
