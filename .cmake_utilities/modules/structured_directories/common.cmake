...
function(glob_module OUT_VARIABLE CXX_MODULE_DIRECTORY)
    foreach (CXX_MODULE_FILE_EXTENSION M m mm mpp ixx cppm ccm cxxm c++m)
        list(APPEND CXX_MODULE_PATTERNS "${CXX_MODULE_DIRECTORY}/*.${CXX_MODULE_FILE_EXTENSION}")
    endforeach ()
    file(GLOB_RECURSE ${OUT_VARIABLE} ${CXX_MODULE_PATTERNS})
