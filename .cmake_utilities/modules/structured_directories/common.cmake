...
function(glob_header OUT_VARIABLE CXX_HEADER_DIRECTORY)
    foreach (CXX_HEADER_FILE_EXTENSION ${CMAKE_CXX_HEADER_FILE_EXTENSIONS})
        cmake_path(APPEND CXX_HEADER_PATTERN "${CXX_HEADER_DIRECTORY}" "*.${CXX_HEADER_FILE_EXTENSION}")
        list(APPEND CXX_HEADER_PATTERNS "${CXX_HEADER_PATTERN}")
    endforeach ()
